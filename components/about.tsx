  ...
  return (
    <SectionWrapper id="about">
      ...
      <motion.p variants={getFadeIn("", "", 0.1, 1)} className="mt-4 max-w-4xl text-[17px] leading-[30px]">
        I&apos;m a frontend developer with 4 years of experience. I do stuff mostly in React.js. I&apos;m also a big fan
        of Tailwind CSS and TypeScript. <br />I love learning new things and applying them in my projects. Currently,
